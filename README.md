...
## Project Description:
A client has designed a modern, responsive single-page portfolio website using Next.js. He needs this website hosted on a robust, scalable, and cost-effective platform with global availability and fast loading times.
...
## Project Objectives
1. Activities on this project:
2. Deploy a Next.js website on AWS
3. Implement Infrastructure as Code using Terraform
4. Configure global content delivery with AWS CloudFront
5. Apply security and performance best practices
6. Host all project files and code on GitHub
