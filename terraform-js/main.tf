...
resource "aws_s3_bucket" "nextjs_bucket" {
    bucket = "nextjs-portfolio-bucket-ak"
}
...
resource "aws_cloudfront_distribution" "nextjs_distribution" {
    origin {
        ...
        origin_id = "nextjs-portfolio-bucket-ak"
    ...
    default_cache_behavior {
        ...
        target_origin_id = "nextjs-portfolio-bucket-ak"
...
output "bucket_website_endpoint" {
  value = aws_s3_bucket.nextjs_bucket.bucket_regional_domain_name
}
